document.write(`<nav class="navbar fixed-top navbar-expand-md navbar-dark bg-faded" style="background: rgb(2,40,81)">
    ...
    <a class="navbar-brand nav-bracket" href="../index.html">MASOUD JASBI</a>
    <div class="collapse navbar-collapse justify-content-end" id="nav-content">
        <ul class="navbar-nav">
            ...
            <li class="nav-item"><a class="nav-link nav-bracket" href="https://l3lab.ucdavis.edu/">L3 LAB</a></li>
        </ul>
    </div>
</nav>`);
